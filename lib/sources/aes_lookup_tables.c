...
static uint8_t inv_sBox[] = {   // Inverted substitution table (invS-box), used for invSubByte() transformation.
...
// precomputed lookup tables used for polynomial multiplication.

static uint8_t polyMul_0x02_lookup[] = {
...
{
    return polyMul_0x02_lookup[value];
};

static uint8_t polyMul_0x03_lookup[] = {
...
{
    return polyMul_0x03_lookup[value];
};

static uint8_t polyMul_0x0E_lookup[] = {
...
{
    return polyMul_0x0E_lookup[value];
};

static uint8_t polyMul_0x09_lookup[] = {
...
{
    return polyMul_0x09_lookup[value];
};

static uint8_t polyMul_0x0D_lookup[] = {
...
{
    return polyMul_0x0D_lookup[value];
};

static uint8_t polyMul_0x0B_lookup[] = {
...
{
    return polyMul_0x0B_lookup[value];
};
